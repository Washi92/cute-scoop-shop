        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href={withBasePath("/catalog")} className="text-sm text-foreground/60 hover:text-primary transition-colors">All Scoops</Link></li>
              <li><Link href={withBasePath("/product/mystery-scoop-classic")} className="text-sm text-foreground/60 hover:text-primary transition-colors">Mystery Scoops</Link></li>
              <li><Link href={withBasePath("/product/packing-video")} className="text-sm text-foreground/60 hover:text-primary transition-colors">Packing Video</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href={withBasePath("/faq")} className="text-sm text-foreground/60 hover:text-primary transition-colors">FAQ</Link></li>
              <li><Link href={withBasePath("/contact")} className="text-sm text-foreground/60 hover:text-primary transition-colors">Contact Us</Link></li>
              <li><Link href={withBasePath("/policies/shipping")} className="text-sm text-foreground/60 hover:text-primary transition-colors">Shipping Policy</Link></li>
              <li><Link href={withBasePath("/policies/returns")} className="text-sm text-foreground/60 hover:text-primary transition-colors">Return Policy</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href={withBasePath("/policies/privacy")} className="text-sm text-foreground/60 hover:text-primary transition-colors">Privacy Policy</Link></li>
              <li><Link href={withBasePath("/policies/terms")} className="text-sm text-foreground/60 hover:text-primary transition-colors">Terms of Service</Link></li>
            </ul>
